...
export const personalProjects: IPersonalProject[] = [
  {
    ...
    date: '2024',
    description:
      "Developed a website for artist Nick Hakim, along with <a href='https://peter.digital' target='_blank'>Peter Campanelli</a>",
  },
  {
    ...
    date: '2022',
    description:
      "Developed a shopify merchandise store for rapper Baby Keem, along with <a href='https://peter.digital' target='_blank'>Peter Campanelli</a>",
  },
  {
    ...
    date: '2022',
    description:
      "Recipe sharing website with Sign-In with Google, profiles, tags, and search by tags. I used React for building the UI, TypeScript to increase type safety, and Tailwind CSS for styling. <a href='https://github.com/isaacmattern/what-are-you-cooking' target='_blank'>View on GitHub</a>",
  },
  {
