...
export const personalProjects : IPersonalProject[] = [
  {
    ...
    date: "2024",
    description: "Developed a website for artist Nick Hakim, along with Peter Campanelli"
  },
  {
    title: "Baby Keem Online Store",
    url: "https://keem.science",
    date: "2022",
    description: "Developed a shopify merchandise store for rapper Baby Keem, along with Peter Campanelli"
  },
  {
    title: "What Are You Cooking?",
    url: "https://what-are-you-cooking.vercel.app",
    date: "2022",
    description: "Recipe sharing website with Sign-In with Google, profiles, tags, and search by tags. I used React for building the UI, TypeScript to increase type safety, and Tailwind CSS for styling."
  },
  {
...
// Below: versions with links in descriptions
