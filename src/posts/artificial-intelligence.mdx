---
title: Code Faster, Understand Less
date: 2025-3-26
description: There's still no such thing as free lunch.
---
...
1. If you do really understand it, then was the cognitive load of reading code that someone else (the AI) wrote actually less than you writing it yourself? Sometimes, I think the answer to this question could be yes. But I think that most of the time, the answer is probably no. 
2. If you don't understand it, then we have a problem. Now there is new code being committed to your team's repository that potentially no one understands. Hopefully you can use AI to debug the garbage you just wrote in a few weeks after someone else finds a new defect!

<Tweet
  link={"https://twitter.com/iamdevloper/status/1902628884278894941?ref_src=twsrc%5Etfw"}
  author={"I Am Devloper (@iamdevloper)"}
  dateString={"March 20, 2025"}
  textContent={"vibe coding, where 2 engineers can now create the tech debt of at least 50 engineers"}
/>
