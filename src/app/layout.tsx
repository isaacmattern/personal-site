        ...
        <div className='mx-auto max-w-3xl'>
          ...
          <footer className='mx-4 xs:mx-6 text-sm block sm:flex items-center justify-between footer'>
              ...
              <div className='opacity-100 flex items-center justify-center gap-4'>
                <div>
                  <Link href="https://github.com/isaacmattern" className='blue-link'>
                    {"GitHub"}
                    </Link>
                </div>
                <div>
                  <Link href="https://www.linkedin.com/in/isaacmattern/" className='blue-link'>
                    {"LinkedIn"}
                  </Link>
                </div>
                <div>
                  <Link href="mailto:isaac.mattern@gmail.com" className='blue-link'>
                    {"Contact"}
                  </Link>
                </div>
              </div>
